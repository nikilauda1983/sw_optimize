...
import swrunes.RunePermutation;
import swrunes.RuneType;
import static swrunes.RuneType.ATK;
import static swrunes.RuneType.CD;
import static swrunes.RuneType.CR;
import static swrunes.RuneType.DEF;
import static swrunes.RuneType.HP;
import static swrunes.RuneType.SPD;
...
public class RuneManager extends javax.swing.JFrame {
        ...
        jTableAllRunes.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent event) {
                if (jTableAllRunes.getSelectedRow() > -1) {
                    ...
                    mainWindow.drawRune(r1, jLabelSelectedRune,jCheckCountPower.isSelected());
                    focusRune = r1;
    ...
    public void updateAllrunesTable() {
        ...
        jTableAllRunes.getColumnModel().getColumn(0).setCellRenderer(new mainWindow.IconRenderer());

        double d1 = 1.0;
        BufferedImage ic1 = mainWindow.scaleImage(mainWindow.getRuneIcon(SwManager.runes.get(0)), d1);

        mainWindow.setupTable(jTableAllRunes);
        ...
        for (RuneType r1 : SwManager.runes) {
            ...
            if (jRuneSearchFilter.getSelectedIndex() > 0) {
                if (r1.statfix[jRuneSearchFilter.getSelectedIndex() - 1] < mainWindow.getInt(jTextSearchRuneFilter)) {
                    ok = false;
                }
        ...
        mainWindow.drawRune(runeList.get(0), jLabelSelectedRune);
        for (int i = 0; i < runeList.size(); i++) {
            ...
            jTableAllRunes.getModel().setValueAt(new ImageIcon(mainWindow.scaleImage(mainWindow.getRuneIcon(r1), d1)), i, 0);
            int totalSub = 0;
            int atkSub = 0;
            int defSub = 0;
    ...
    public mainWindow main2;
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:        
        PetType curPet = mainWindow.curPet;
    ...
    public void showRuneEdit(RuneType r1){        
        ...
        mainWindow.drawRune(r1, jLabelRuneEdit);        
    ...
    private void jComboLevelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboLevelActionPerformed
        ...
        if (!loadingData && curRuneEdit!=null){
            ...
            if (value>0){                
                ...
                mainWindow.drawRune(curRuneEdit, jLabelRuneEdit);       
            }
        }
    ...
    public void updateSubStat(){
        ...
        for (int i=0;i<4;i++){    
            if (comboList.get(i).getSelectedIndex()>0){
                ...
                curRuneEdit.subStat2.add(mainWindow.getInt(textList.get(i)));
            }
        }  
        curRuneEdit.updateSubStats();
        curRuneEdit.mainStatVal = mainWindow.getInt(jTextMainStat);
        mainWindow.drawRune(curRuneEdit, jLabelRuneEdit);              
    }
    ...
    private void jCheckCountPowerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckCountPowerActionPerformed
        // TODO add your handling code here:
        if (focusRune!=null){
            mainWindow.drawRune(focusRune, jLabelSelectedRune,jCheckCountPower.isSelected());
        }
