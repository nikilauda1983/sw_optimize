...
public class RuneManager extends javax.swing.JFrame {
    ...
    private JButton jButtonRuneSearch;
    private JButton jButtonSave;
    private JButton jButtonViewAll;
    private JCheckBox jCheckCountPower;
    private JCheckBox jCheckEditedRunes;
    private JCheckBox jCheckStorageRunes;
    private JComboBox<String> jComboBox1;
    private JComboBox<String> jComboBox2;
    private JComboBox<String> jComboBox3;
    private JComboBox<String> jComboBox4;
    private JComboBox<String> jComboBox6;
    private JComboBox<String> jComboLegend;
    private JComboBox<String> jComboLevel;
    private JComboBox<String> jComboOrigin;
    private JComboBox jComboRunePet;
    private JComboBox jComboSearchRuneGrade;
    private JComboBox jComboSearchRuneLevel;
    private JComboBox<String> jComboSearchRuneSlot;
    private JComboBox jComboSearchRuneStat;
    private JComboBox<String> jComboSearchRuneType;
    private JComboBox<String> jComboUngrind;
    ...
    private JLabel jLabelRuneEdit;
    private JLabel jLabelRuneOwner;
    private JLabel jLabelSelectedRune;
    private JComboBox<String> jRuneSearchFilter;
    private JScrollPane jScrollPane3;
    private JTable jTableAllRunes;
    private JFormattedTextField jTextMainStat;
    private JTextField jTextNumRows;
    private JTextField jTextPetName;
    private JFormattedTextField jTextSearchRuneFilter;
